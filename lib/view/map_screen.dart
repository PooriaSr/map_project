...
class _MapScreenState extends State<MapScreen>
  ...
  void initState() {
    ...
    timer(setState, _mapScreenController);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: _mapScreenController.loading == true
                ...
                FlutterMap(
                  ...
                  options: MapOptions(
                      ...
                      initialCenter: LatLng(
                          _mapScreenController.myPosition.latitude,
                          _mapScreenController.myPosition.longitude)),
                  children: [
                    TileLayer(
                        tms: false,
                        ...
                        ? Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  _mapScreenController.getDistance()['km'] ==
                                          "0"
                                      ? distMsg(context, _mapScreenController)
                                          .first
                                      : distMsg(context, _mapScreenController)
                                          .last,
                                  FutureBuilder(
